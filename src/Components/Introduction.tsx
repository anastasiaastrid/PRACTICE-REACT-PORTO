function Introduction() {
  return (
    <div className="flex flex-col items-center w-full px-4">
      ...
      <h2 className="mt-10 text-sm md:text-lg text-black font-medium tracking-widest">HELLO! MY NAME IS</h2>
      <h2 className="text-4xl md:text-6xl mt-2 text-black font-bold tracking-widest">ANASTASIA ASTRID</h2>
      <div className="mt-7">
